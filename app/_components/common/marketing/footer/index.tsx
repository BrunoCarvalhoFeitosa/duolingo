...
export const Footer = () => {
  ...
  return (
    <footer className="relative mt-24 w-full">
      <div className="absolute -top-7 lg:top-12 2xl:top-28 left-2/4 -translate-x-2/4 mx-auto w-full md:w-2/4 lg:w-[40%] 2xl:w-2/6 flex flex-col gap-2 md:gap-8 lg:gap-3 2xl:gap-8 z-10">
      ...
      <div className="-mt-1 py-14 xl:pt-8 w-full bg-lime-500">
        <div className="mx-auto lg:px-5 w-3/4 lg:w-full 2xl:w-[80%] grid grid-cols-1 xl:grid-cols-5 gap-24 lg:gap-5 2xl:gap-24 place-items-center xl:place-items-start text-center xl:text-left">
          <div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              <li>
                <Link href="/">{t("footer.columns.products.duolingo")}</Link>
              </li>
              <li>
