...
<<<<<<< HEAD:app/(marketing)/_components/free-use-section.tsx
export const FreeUseSection = () => {
  const { t } = useTranslation();
=======
export const HomeFreeUseSection = () => {
    const { t } = useTranslation()
>>>>>>> 527334eb347a4e1d378ea21e68d267806d59566c:app/(marketing)/_components/home-free-use-section.tsx
